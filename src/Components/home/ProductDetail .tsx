...
const ProductDetail = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row justify-center items-center w-full bg-white p-4 md:p-8 border '>
      ...
      <div className='w-full lg:w-1/2 max-w-md'>
        ...
        <div className='flex flex-col sm:flex-row gap-4'>
          ...
          <button className='flex items-center justify-center gap-2 bg-orange-500 text-white font-bold py-3 px-6 rounded-lg shadow-md hover:bg-orange-600 transition-colors w-full sm:w-auto'>
